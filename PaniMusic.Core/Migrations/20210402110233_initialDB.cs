        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quality128 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Qulity320 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoverImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Qulity480 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quality720 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quality1080 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicVideos_Styles_StyleId",
                        column: x => x.StyleId,
                        principalTable: "Styles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quality128 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quality320 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Lyric = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Visit = table.Column<int>(type: "int", nullable: false),
                    RecordDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Link = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_MusicVideos_MusicVideoId",
                        column: x => x.MusicVideoId,
                        principalTable: "MusicVideos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_AlbumId",
                table: "Feedbacks",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_MusicVideoId",
                table: "Feedbacks",
                column: "MusicVideoId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_TrackId",
                table: "Feedbacks",
                column: "TrackId");
